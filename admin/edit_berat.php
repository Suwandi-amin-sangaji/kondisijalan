                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Edit Kerusakan Berat</h5>
                                    </div>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                                        <li class="breadcrumb-item"><a href="#!">Lokasi</a></li>
                                        <li class="breadcrumb-item"><a href="#!">Edit Kerusakan Berat</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <?php 
                                                        $id = $_GET['id'];
                                                        $data = mysqli_query($con,"SELECT * FROM tb_berat JOIN tb_jalan ON tb_berat.id_jalan=tb_jalan.id_jalan
                                                            WHERE id_berat='$id'");
                                                    ...
                                                    <br>
                                                    <form action="update_berat.php" method="post">
