                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Tambah Kerusakan Sedang</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php"><i
                                                class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Lokasi</a></li>
                                    <li class="breadcrumb-item"><a href="#!">Tambah Kerusakan Sedang</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="GET">
                                                    ...
                                                    <center>
                                                        ...
                                                        <a class="btn btn-danger" href="data_sedang.php">Kembali</a>
                                                    </center>
                                                </form>
                                                <?php
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <center>
                                                    <div id="googleMap" style="width:1000px;height:500px;"
                                                        align="center"></div>
                                                </center>
                                                <br>
                                                <form action="simpan_sedang.php" method="post">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Nama Jalan"
                                                            name="a" required value="<?php echo $tpeg['nama']; ?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Jumlah Lubang" name="b" required
