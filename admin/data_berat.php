                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Data Kerusakan Berat</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php"><i
                                                class="feather icon-home"></i></a></li>
                                    <li class="breadcrumb-item"><a href="#!">Lokasi</a></li>
                                    <li class="breadcrumb-item"><a href="#!">Data Kerusakan Berat</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        $_SESSION['pesan'] = '';
                                        ?>
                                        <a href="tambah_berat.php" class="btn btn-info btn-sm">Tambah Data</a>
                                        <br>
                                        <br>
                                        <div class="key-act-button">
                                            <table id="key-act-button"
                                                ...
                                                <tbody>
                                                    <?php
                                                    $noUrut = 0;
                                                    $result = mysqli_query($con, "SELECT * FROM tb_berat 
                                                    ...
                                                    <tr align="center" valign="baseline">
                                                        ...
                                                        <td>
                                                            <a href="edit_berat.php?id=<?php echo $row['id_berat']; ?>"
                                                                class="btn btn-warning btn-sm feather icon-edit"></a>
                                                            <a href="hapus_berat.php?id=<?php echo $row['id_berat']; ?>"
