                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        $_SESSION['pesan'] = '';
                                        ?>
                                        <a href="tambah_sedang.php" class="btn btn-info btn-sm">Tambah Data</a>
                                        <br>
                                        <br>
                                        <div class="table-responsive">
                                            <table id="key-act-button"
                                                ...
                                                <tbody>
                                                    <?php
                                                    $noUrut = 0;
                                                    $result = mysqli_query($con, "SELECT * FROM tb_sedang 
                                                    ...
                                                    <tr align="center" valign="baseline">
                                                        ...
                                                        <td>
                                                            <a href="edit_sedang.php?id=<?php echo $row['id_sedang']; ?>"
                                                                class="btn btn-warning btn-sm feather icon-edit"></a>
                                                            <a href="hapus_sedang.php?id=<?php echo $row['id_sedang']; ?>"
